...
class DbExecutor:
    ...
    def create_table_conductor(self):
        ...
        sql = "CREATE TABLE conductores (id_conductor INT AUTO_INCREMENT PRIMARY KEY, id_orden VARCHAR(255) NULL, direccion_entrega VARCHAR(255) NULL, time_stamp VARCHAR(255) NULL)"
